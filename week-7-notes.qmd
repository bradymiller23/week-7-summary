...
* Want to be able to write out loss funciton & automatically be able to caluclate
loss for each parameter
* calcualting gradinets for any funciton w/o the need to solve tedious calc
  problems
```{r}
# vector of 5 values
